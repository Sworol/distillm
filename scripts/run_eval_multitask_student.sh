#!/bin/bash
# Evaluate multi-task DistiLLM student on 5 benchmarks
set -euo pipefail

TORCHRUN="/anaconda3/envs/llm_train/bin/torchrun"
BASE_PATH="/home/ufile/group_3/zjx/distillm"
CKPT="${BASE_PATH}/results/gpt2/train/distill_multitask/9300"
CKPT_NAME="distill_multitask/9300"
...
RESULTS_FILE="${SAVE}/multitask_student_seed${SEED}.txt"
echo "Multi-task Student 5-Benchmark (seed=${SEED})" | tee "$RESULTS_FILE"
