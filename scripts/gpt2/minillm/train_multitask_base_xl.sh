#! /bin/bash
# MiniLLM baseline: gpt2-base ← gpt2-xlarge multi-task teacher (PPO-based)
...
CKPT_NAME="init-multitask"
CKPT="${BASE_PATH}/results/gpt2/train/init_multitask/e3-bs8-lr0.0005-G1-N4-NN1/5583"
...
# data
PROMPT_DATA_DIR="${BASE_PATH}/processed_data/combined_prompt/gpt2/"
