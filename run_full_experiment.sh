...
set -euo pipefail
#
# Full DistiLLM experiment: gpt2-base ← gpt2-xlarge (3 stages)
...
# ============================================================
# Stage 1: Teacher SFT (gpt2-xlarge) — 10 epochs
# ============================================================
echo "=============================================="
...
TEACHER_RUN_DIR="${BASE_PATH}/results/gpt2/train/sft/e10-bs2-lr5e-05-G1-N4-NN1"
TEACHER_CKPT="${TEACHER_RUN_DIR}/17500"
...
STUDENT_RUN_DIR="$(ls -dt ${BASE_PATH}/results/gpt2/train/init/gpt2-base/e3-* 2>/dev/null | head -n 1)"
